...
if [[ "$UI_FRAMEWORK" == "streamlit" ]]; then
  ...
  exec streamlit run src/app.py --server.address "$UI_HOST" --server.port "$UI_PORT" --server.headless true --server.baseUrl /jupyter-hack-team-2292-260609123044-3e5e28e7/proxy/8501/
else
